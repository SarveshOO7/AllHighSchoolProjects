...
public class Processor {
    ...
    public ComputerMoveReturn computerMove(int[][] matrix){
        int totalCountMatrix[][]= new int[8][8],strategicMatrix[][]= new int[8][8],sumMatrix[][] = new int[8][8];
            ...
            for (int j =0;j<8;j++){
                ...
                if(matrix[i][j]==0) {
                    ...
                    if(totaCountMatrix[i][j]!=0)
                       totalCountMatrix[i][j]=strategicMatrix[i][j]+totaCountMatrix[i][j];
                    if(i==6||i==1||j==6||j==1){
